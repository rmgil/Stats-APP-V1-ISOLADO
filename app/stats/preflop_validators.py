...
Created: Oct 20, 2025
Updated: Nov 11, 2025 - Refactored to inherit from ValidatorBase
...
class PreflopOpportunityValidator(ValidatorBase):
    """
    Validator for preflop stat opportunities.
    Inherits shared logic from ValidatorBase.
    
    Handles:
    - Stack validations per stat type (≥16bb rules)
    - Position-specific validation for RFI/Steal
    - Raiser/caller validation for 3bet/CC/Squeeze
    """
